...
documents = []
documents.extend(UUD_splits)
documents.extend(PKM_splits)
documents.extend(AI_splits)
...
chromavs = Chroma.from_documents(
     documents=documents,
     embedding=embedding_firqaa
)

# get_chromavs.similarity_search("Apa itu PKM-KI?")